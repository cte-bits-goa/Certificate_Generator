...
\DTLloaddb{name}{Records.csv}       % data.csv includes information from database
 %=============================
%=============================
...
%=============================
\DTLforeach{name}{
	\name=Name, \course=Dep, \certype=Type, \authlink=CERT_ID}{ %defining variables from the csv file 
	%=============================
	\noindent
